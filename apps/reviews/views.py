...
def main_page(request):
    ...
    tickets_without_review = Ticket.objects.filter(review__isnull=True, user__in=following)
    tickets_with_review = Ticket.objects.filter(review__isnull=False, user__in=following)

    reviews = Review.objects.filter(Q(user__in=following) | Q(ticket__user__in=following))
